...
# xml文件存放目录(修改成自己的文件名)
input_dir = '/home/viewer/Downloads/model_zoo/DatasetId_1868434_1687961395/Annotations'

# 输出txt文件目录（自己创建的文件夹）
out_dir = '/home/viewer/Downloads/model_zoo/DatasetId_1868434_1687961395/txts'
